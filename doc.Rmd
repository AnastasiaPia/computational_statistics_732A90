...
In the myvar function formula we have subtraction. When we have two large and nearly equal numbers this causes problems with the calculation. For example, for this example we got a negative number for the variance calculation.
